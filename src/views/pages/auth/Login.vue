            ...
            <div style="border-radius: 56px; 
                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    <div class="text-center mb-5">
                        ...
                        <div class="text-900 text-3xl font-medium mb-3">Reportes planeacion</div>
...
const iniciarSesion = () => {
    if (email.value == 'adesarrollo3@unico.com.co' && password.value == '12345') {
        ruta.push('/inicio/dashboard');
    }
};
