...
<template>
    <DataTable :value="sales" rowGroupMode="rowspan" :groupRowsBy="sales.product" responsiveLayout="scroll">
        <ColumnGroup type="header">
            <Row>
                <Column :rowspan="2">
                    <Calendar v-model="cal" view="month" dateFormat="mm/yy" />
                </Column>
                <Column header="Semana" :colspan="4" />
            </Row>
            <Row>
                <Column header="Semana (01-31) Dic" :colspan="4" />
            </Row>
            <Row>
                <Column header="Concepto" :sortable="true" field="lastYearSale" />
                <Column header="Descripcion" :sortable="true" field="lastYearSale" />
                <Column header="Ejecucion" :sortable="true" field="lastYearSale" />
...
export default {
    setup() {
        const cal = ref(null);
        const sales = ref([
            { product: '01', lastYearSale: "RECAUDOS FEE PAO", thisYearSale: 10000000, lastYearProfit: 54406, thisYearProfit: 43342, porcentaje: 5 },
            { product: '0101', lastYearSale: "REACAUDOS FEE CS-CC", thisYearSale: 10000000, lastYearProfit: 423132, thisYearProfit: 312122, porcentaje: 40 },
            { product: '010101', lastYearSale: "OTROS RECAUDOS", thisYearSale: 5000000, lastYearProfit: 12321, thisYearProfit: 8500, porcentaje: 100 },
            { product: '010101', lastYearSale: "EGRESOS", thisYearSale: 22000000, lastYearProfit: 745232, thisYearProfit: 65323, porcentaje: 7 },
            { product: '010102', lastYearSale: "PAGO NOMINA", thisYearSale: 79000000, lastYearProfit: 643242, thisYearProfit: 500332, porcentaje: 6 },
            { product: '0102', lastYearSale: "PAGOS DE HONORARIOS", thisYearSale: 65000000, lastYearProfit: 421132, thisYearProfit: 150005, porcentaje: 4 },
            { product: '010201', lastYearSale: "PAGO DE IMPUESTOS", thisYearSale: 12000000, lastYearProfit: 131211, thisYearProfit: 100214, porcentaje: 19 },
            { product: '010202', lastYearSale: "PAGO DE SEGUROS", thisYearSale: 45000000, lastYearProfit: 66442, thisYearProfit: 53322, porcentaje: 69 },
            { product: '010203', lastYearSale: "PAGO DE PAGO TI", thisYearSale: 560000000, lastYearProfit: 765442, thisYearProfit: 296232, porcentaje: 74 },
            { product: '010203', lastYearSale: "PAGO DE VIGILANCIA", thisYearSale: 5400000, lastYearProfit: 21212, thisYearProfit: 12533, porcentaje: 15 }
        ]);
